...
export default function Hero(){
    ...
    return(
        <section className="relative bh-min-vh-60">
                <button
                onClick={prev}
                className="rounded-full h-10 w-10 opacity-50 bg-gray-300 hover:bg-gray-50 absolute top-1/2 z-50" style={{left:"5%"}}>
                    <i className="bi bi-arrow-left bh-text-primary"></i>
                </button>
                <button 
                 onClick={next}
                className="rounded-full h-10 w-10 opacity-50 bg-gray-300 hover:bg-gray-50 absolute top-1/2 z-50" style={{right:"5%"}}>
